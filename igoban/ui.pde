...
public  int DstoneStroke= 30;

int CEBUNUMBER = 1;

String mazename = "setname";
int namecounter = 0;
 ...
 //maze name
  ...
  // floorwidth
   ...
   // floorwidth
      ...
      .moveTo("config");
    // floorwidth
       cp5.addSlider("stoneStroke")
       .setBroadcast(false)
       .setValue(DstoneStroke)
       .setRange(5,200)
       .setPosition(0,170)
       .setSize(220,20)
       .setBroadcast(true)
...
void stoneSize ( int value )
{
  maze.ssCallback(value);
  DstoneSize = value;
}
void stoneStroke ( int value )
{
...
void saveSVG(){
  String filename = getDateFormed() + "_igo_"  +  cp5.get(Textfield.class,"mazename").getText() + "_" + namecounter +".svg";
